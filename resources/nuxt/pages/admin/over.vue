        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="admin-title-1">About pagina</h1>
                    <p class="admin-text-1">Hier kan je de about pagina bewerken.</p>
                </div>
            </div>

            <div class="space-y-6 sm:space-y-5">
                <InputString v-model="pageStore.about.title" label-text="Titel" />
                <InputImageUpload v-model="pageStore.about.image" label-text="Achtergrond foto" />
                <InputRichText v-model="pageStore.about.description" label-text="Beschrijving" />
            </div>
...
definePageMeta({ auth: true, title: 'Over ons'})
