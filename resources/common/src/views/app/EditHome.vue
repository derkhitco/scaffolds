<template>
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-6 sm:space-y-5">
            <StringInput v-model="pageStore.home.title" label-text="Titel" />
            <ImageUpload v-model="pageStore.home.image" label-text="Achtergrond foto" />
            <RichTextInput v-model="pageStore.home.description" label-text="Beschrijving" />
        </div>
